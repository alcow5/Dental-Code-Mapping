...
3. Crown types - be very specific:
   - D2710: "Crown - resin (indirect)" - full resin crown
...
6. Surgical procedures:
   - D7520: "Incision and drainage of abscess - extraoral soft tissue" - for abscess drainage
   - D7530: "Removal of foreign body from mucosa, skin, or subcutaneous alveolar tissue" - for foreign body removal
7. Occlusal guards:
...
8. Post and core procedures:
   - D2954: "Prefabricated post and core in addition to crown" - post and core with crown
9. Match the procedure description as closely as possible
10. Consider the number of surfaces, tooth type, and material when applicable
11. Set confidence as "high", "medium", or "low" based on how well the procedure matches
12. If no exact match exists, provide the closest relevant code with "low" confidence
13. Include multiple codes if the procedure involves multiple distinct services"""
